...
<DocImage
  src="/media/account-management/user/user-list.png"
  caption="User List View"
/>
...
<DocImage
  src="/media/account-management/user/user-tree-view.png"
  alt="Tree View"
  caption="User Tree View"
/>
...
<DocImage
  src="/media/account-management/user/user-add.png"
  caption="Add User"
/>
...
<DocImage
  src="/media/account-management/user/user-edit.png"
  caption="Edit User"
/>
...
<DocImage
  src="/media/account-management/user/user-assign-role.png"
  caption="Assign Role"
/>
...
<DocImage
  src="/media/account-management/user/user-search.png"
  alt="Search User"
  caption="Searching for Users"
/>
...
<DocImage
  src="/media/account-management/user/user-delete.png"
  alt="Delete User"
...
<DocImage
  src="/media/account-management/user/user-details.png"
  alt="User Details"
  caption="Details of a User"
/>
