...
- **Action** → Quick edit and
  delete functionality. - **Agent Name** → Full Name of the agent. - **Time
  Zone** → The local time setting for a specific geographic region. - **Calling
  Window** → The permitted time range during which calls can be made to contacts
  or leads. - **Working Days** → The designated days when business operations or
  activities are performed. - **Break** → A scheduled pause or rest period
  during working hours. - **Status** → Active/Inactive.
</details>

<DocImage
  src="/media/system-configuration/call-manager/agent-calling-window-list.png"
  alt="Agent Calling Window Configuration"
  caption="Agent Calling Window Setup"
/>
...
<DocImage
  src="/media/system-configuration/call-manager/agent-calling-window-add.png"
  alt="AAdd gent Calling Window Configuration"
  caption="Agent Calling Window Setup"
/>
...
<DocImage
  src="/media/system-configuration/call-manager/agent-calling-window-edit.png"
  alt="Update Agent Calling Window Configuration"
  caption="Edit Agent Calling Window"
/>
...
<DocImage src="/media/system-configuration/call-manager/agent-calling-window-delete.png" alt="Delete Agent Calling Window Configuration" caption="Delete Agent Calling Window" />
...
<DocImage
  src="/media/system-configuration/call-manager/agent-calling-window-search.png"
  alt="Search Agent Calling Window Configuration"
  caption="Search Agent Calling Window"
/>
...
<DocImage
  src="/media/system-configuration/call-manager/outcome-time.png"
  caption="Outcome Time"
/>
