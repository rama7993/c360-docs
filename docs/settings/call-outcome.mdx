...
<figure>
  <img
    src="/media/system-configuration/call-outcome/call-outcome-action.png"
    alt="Lead Call Outcome Configuration"
  />
...
<TabItem value="not-interested-reason" label= " 👎 Not Interested Reason">

:::note
Represents the reason why a lead is not interested in a product or service.
:::
...
<figure>
  <img
    src="/media/system-configuration/call-outcome/not-interested-reason.png"
    alt="Not Interested Reason"
  />
  <figcaption>Not Interested Reason</figcaption>
</figure>
