...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-list.png"
    alt="Script Wizard list view"
  />
...
- Press **Enter** to run the search.
  <figure>
    <img
      src="/media/crm/script-wizard/script-wizard-search.png"
      alt="Search bar for scripts"
    />
...
- **Category** → Filter by
  script type. - **Status** → View Active, Inactive, or Draft scripts. -
  **Campaign Activity** → Filter by associated campaign. - **Created Date** →
  Filter by creation timeframe.
</details>

<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-filter.png"
    alt="Filter panel for scripts"
  />
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-add-configure.png"
    alt="Add or edit script interface"
  />
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-add-node-library.png"
    alt="Add or edit script interface"
  />
  <figcaption>Add / Edit Script</figcaption>
</figure>
...
:::note - You can add only one greeting in a script.
::: - Arrange the **questions** and **responses** according to your preference.
:::note - You can not connect nodes from an objection block.
::: - click on **Next**.
...
- You can
  zoom in and zoom out the page. - You can reset the zoom. - You can **Hold
  Shift + drag** or middle mouse button to pan.
</details>

<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-add-build.png"
    alt="Add or edit script interface"
  />
  <figcaption>Add / Edit Script</figcaption>
</figure>
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-add-preview.png"
    alt="Add script interface"
  />
...
- Additionally you can
  perform **inline edit** for the script you want.
</details>

<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-edit.png"
    alt="Edit script interface"
  />
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-preview.png"
    alt="Preview script flow"
  />
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-assign-campaign.png"
    alt="Assign script to campaign or lead"
  />
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-assign-user.png"
    alt="Assign script to campaign or user"
  />
  <figcaption>Assign Script</figcaption>
</figure>
...
<figure>
  <img
    src="/media/crm/script-wizard/script-wizard-delete.png"
    alt="Delete action for scripts"
  />
