...
<DocImage
  ...
  caption="Script Wizard list view"
/>
...
## <DocImage src="/media/crm/script-wizard/script-wizard-edit.png" alt="Edit script interface" caption="Edit Script" />
