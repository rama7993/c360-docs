...
- You cant revert the lead back from archive to active once it is archived.
- You cant perform any action on the archived lead except download.
...
<DocImage
  src="/media/crm/lead/lead-import-choose data.png"
  alt="Upload leads from Excel"
  caption="Choose Data"
/>

<DocImage
  src="/media/crm/lead/lead-import-map.png"
  alt="Map Excel columns to lead fields"
  caption="Field mapping"
/>

<DocImage
  src="/media/crm/lead/lead-import.png"
