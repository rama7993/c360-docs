...
- You cant revert the opportunity back from archive to active once it is archived.
- You cant perform any action on the archived opportunity except download.
...
- You can download upto 1000 opportunities at a time.
