...
<DocImage
  src="/media/shortcut/shark-tank-and-round-robin/shark-tank-assign.png"
  alt="Assign leads in Shark Tank"
  caption="Assigning leads into the Shark Tank pool"
/>
...
<DocImage
  src="/media/shortcut/shark-tank-and-round-robin/shark-tank-claim-request.png"
  alt="Claim Leads Table"
  caption="Claim Leads table for users"
/>
...
<DocImage
  src="/media/shortcut/shark-tank-and-round-robin/shark-tank-claim-review-request.png"
  alt="Claim Review Request Table"
  caption="Admin reviewing pending lead claims"
/>
...
<DocImage
  src="/media/shortcut/shark-tank-and-round-robin/round-robin-assign.png"
  alt="Assign leads in Round Robin"
  caption="Assigning leads automatically with Round Robin"
/>
...
<DocImage
  src="/media/shortcut/shark-tank-and-round-robin/round-robin-claim.png"
  alt="Round Robin Lead Alerts"
  caption="Round Robin alerts for users"
/>
