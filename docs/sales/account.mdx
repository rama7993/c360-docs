...
<DocImage
  src="/media/crm/account/account-contact-choose data.png"
  alt="Upload account from Excel"
  caption="Choose Data"
/>

<DocImage
  src="/media/crm/account/account-contact-map field.png"
  alt="Map Excel columns to account fields"
  caption="Field mapping"
/>

<DocImage
  src="/media/crm/account/account-contact-confirm & import.png"
  alt="Summary and import confirmation"
