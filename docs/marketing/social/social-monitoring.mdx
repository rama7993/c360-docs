...
<DocImage
  src="/media/marketing/social/social-monitoring/channel-list.png"
  alt="Social monitoring channels list"
  caption="Connected channels with status and actions"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/channel-add.png"
  alt="Social monitoring add channel"
  caption="Adding Channel Into the Portal"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/channel-search.png"
  alt="Social monitoring search channel"
  caption="Seaching profiles associated with the channel"
/>
...
- To view the social account details page, click on **Channel Name**.
  <DocImage
    src="/media/marketing/social/social-monitoring/channel-details.png"
    alt="Social account details"
    caption="Viewing Social Account Details Page"
  />
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-list.png"
  alt="Post Listing Page"
  caption="Post's based on status accociated with perticular profile"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-add-add-campaign.png"
  alt="Add Post Page"
  caption="Add Post page where need to fill campaign details"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-add-create.png"
  alt="Content Creation Page"
  caption="Provide Post Content"
/>
...
<DocImage src="/media/marketing/social/social-monitoring/post-add-publish.png" alt="Publish Post Page" caption="Publish/Schedule Post Content" />
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-filter.png"
  alt="Post Filter"
  caption="Searching Post by filter"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-filter-publish.png"
  alt="All Published Post "
  caption="Publish Post via different profiles"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-filter-unpublish.png"
  alt="Unpublished  Post"
  caption="All Unpublished Post"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-filter-draft.png"
  alt="Draft Post"
  caption="All Draft Post"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-filter-schedule.png"
  alt="scheduled Post"
  caption="All scheduled Post"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-delete.png"
  alt="Deleted Post"
  caption="Remove Post from the list"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-details.png"
  alt="Post Details"
  caption="All Post Social Details About the post"
/>
...
<DocImage
  src="/media/marketing/social/social-monitoring/post-statistics.png"
