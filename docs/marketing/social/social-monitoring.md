...
You can filter Posts by:
 ...
 <details>
 <summary>Click to See Available Filter</summary>
 
 1. **Date** : Using **Date** Filter you can short the post records.
 2. **Created At** : Selects a specific time period(**Today, 1 week ago,1 month ago,1 year ago**)  or you can **Costumize** the your time period for analysis.
...
1. **Impression** : The total number of times the post was displayed to users.
