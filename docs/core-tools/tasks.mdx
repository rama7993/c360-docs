...
<DocImage
  src="/media/shortcut/task/task-navigation.png"
  alt="Accessing tasks in C360"
  caption="Accessing the Tasks Management dashboard"
/>
...
<DocImage
  src="/media/shortcut/task/task-list.png"
  alt="Viewing task list in CRM"
  caption="Task list with details and quick access"
/>
...
<DocImage
  src="/media/shortcut/task/task-filter.png"
  alt="Filtering tasks by type, status, and priority"
  caption="Filtering tasks by relation, status, priority, and appointment type"
/>
...
<DocImage
  src="/media/shortcut/task/task-add-button.png"
  alt="Add Task button in CRM"
  caption="Adding a new task from the task list"
/>
...
<DocImage
  src="/media/shortcut/task/task-add.png"
  alt="Task creation form"
  caption="Task creation form with required fields"
/>

<DocImage
  src="/media/shortcut/task/task-range-of-recurrence.png"
  alt="Recurring task reminder option"
  caption="Setting recurring reminders for tasks"
/>
...
<DocImage
  src="/media/shortcut/task/task-add-crm-record.png"
  alt="Adding a task from a CRM record"
  caption="Adding a task directly from a Lead, Contact, or Opportunity"
/>
...
<DocImage
  src="/media/shortcut/task/task-upcoming.png"
  alt="Upcoming tasks in dashboard view"
  caption="Upcoming tasks displayed on the home dashboard"
/>
