...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-navigation.png"
  alt="Lead alerts pop-up in C360"
  caption="Lead Alerts pop-up showing recent lead notifications"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-sales-list.png"
  alt="Sales and marketing alerts with labels"
  caption="Different alert types displayed in Sales and Marketing tabs"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-marketing-list.png"
  alt="Sales and marketing alerts with labels"
  caption="Different alert types displayed in Sales and Marketing tabs"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-status-filter.png"
  alt="Filter lead alerts by read/unread status"
  caption="Filter lead alerts by status"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-assignment-filter.png"
  caption="Filter lead alerts by assignment type"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-date-filter.png"
  alt="Filter lead alerts by time period"
  caption="Filter lead alerts by date"
/>
...
<DocImage
  src="/media/shortcut/lead-alert/lead-alert-read.png"
  alt="Toggle between unread and read alerts"
  caption="Toggle between Unread and Read alerts"
/>
